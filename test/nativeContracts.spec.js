...
describe('#NativeContracts', function () {
  ...
  describe('NativeContracts instance', function () {
    const na = NativeContracts()
    const { getNativeContractAddress, getNativeContractName, isNativeContract, list } = na
    const addresses = Object.values(defaultNativeContracts)
    const names = Object.keys(defaultNativeContracts)

    describe('getNativeContractAddress()', function () {
      for (const name of names) {
        const address = defaultNativeContracts[name]
